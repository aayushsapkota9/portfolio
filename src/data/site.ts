...
/** Toolkit — grouped to mirror the three focus areas above, not a flat skill dump. */
export const stack = [
  {
  ...
  {
    group: "Data",
    items: ["PostgreSQL", "Prisma", "Redis", "MongoDB"],
  },
  {
    group: "Cloud & DevOps",
    items: [
...
/** "Recent favorite" — plays Spotify's own preview clip through the card's
    button, so there is no embedded Spotify widget to clash with the design.
    Caveat worth knowing: Spotify cuts previews from the MIDDLE of a track, so
    the clip drops in mid-song rather than at 0:00, and it runs ~24s. The
    p.scdn.co URL is unsigned (no expiry token) but Spotify can rotate it — if
    the button ever goes silent, re-pull it from the album's embed page. */
export const nowPlaying = {
  track: "Left Right",
  artist: "Snollebollekes",
  href: "https://open.spotify.com/album/1NIFePZo8FOod6oDtsERYo",
  preview:
    "https://p.scdn.co/mp3-preview/4505cb12363a135dd10d42f9225ec413a537df40",
};
...
export const socials = [
  {
    ...
    handle: "@aayushsapkota9",
  },
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/aayushsapkota9",
    handle: "/in/aayushsapkota9",
  },
  {
    name: "Facebook",
    href: "https://facebook.com/aayushhsapkota9/",
    handle: "@aayushhsapkota9",
  },
  {
    name: "Email",
    href: "mailto:aayushsapkota9@gmail.com",
    handle: "aayushsapkota9@gmail.com",
  },
];
